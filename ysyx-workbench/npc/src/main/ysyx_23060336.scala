...
class ysyx_23060336 extends Module {
  ...
  // Axi4IFU
    ifu.io.axi.awready := axi4ifu.io.awready
    axi4ifu.io.awvalid := ifu.io.axi.awvalid
    axi4ifu.io.awaddr  := ifu.io.axi.awaddr
    axi4ifu.io.awid    := ifu.io.axi.awid
    axi4ifu.io.awlen   := ifu.io.axi.awlen
    axi4ifu.io.awsize  := ifu.io.axi.awsize
    axi4ifu.io.awburst := ifu.io.axi.awburst

    ifu.io.axi.wready  := axi4ifu.io.wready
    axi4ifu.io.wvalid  := ifu.io.axi.wvalid
    axi4ifu.io.wdata   := ifu.io.axi.wdata
    axi4ifu.io.wstrb   := ifu.io.axi.wstrb
    axi4ifu.io.wlast   := ifu.io.axi.wlast

    axi4ifu.io.bready  := ifu.io.axi.bready
    ifu.io.axi.bvalid  := axi4ifu.io.bvalid
    ifu.io.axi.bresp   := axi4ifu.io.bresp
    ifu.io.axi.bid     := axi4ifu.io.bid

    ifu.io.axi.arready := axi4ifu.io.arready
    axi4ifu.io.arvalid := ifu.io.axi.arvalid
    ...
    axi4ifu.io.rready  := ifu.io.axi.rready
    ifu.io.axi.rvalid  := axi4ifu.io.rvalid
    ...
    // Axi4LSU
    lsu.io.axi.awready := axi4lsu.io.awready
    axi4lsu.io.awvalid := lsu.io.axi.awvalid
    axi4lsu.io.awaddr  := lsu.io.axi.awaddr
    axi4lsu.io.awid    := lsu.io.axi.awid
    axi4lsu.io.awlen   := lsu.io.axi.awlen
    axi4lsu.io.awsize  := lsu.io.axi.awsize
    axi4lsu.io.awburst := lsu.io.axi.awburst

    lsu.io.axi.wready  := axi4lsu.io.wready
    axi4lsu.io.wvalid  := lsu.io.axi.wvalid
    axi4lsu.io.wdata   := lsu.io.axi.wdata
    axi4lsu.io.wstrb   := lsu.io.axi.wstrb
    axi4lsu.io.wlast   := lsu.io.axi.wlast

    axi4lsu.io.bready  := lsu.io.axi.bready
    lsu.io.axi.bvalid  := axi4lsu.io.bvalid
    lsu.io.axi.bresp   := axi4lsu.io.bresp
    lsu.io.axi.bid     := axi4lsu.io.bid

    lsu.io.axi.arready := axi4lsu.io.arready
    axi4lsu.io.arvalid := lsu.io.axi.arvalid
    ...
    axi4lsu.io.rready  := lsu.io.axi.rready
    lsu.io.axi.rvalid  := axi4lsu.io.rvalid
  ...
  */
  ...
  axi4lsu.io.clock := clock
  axi4lsu.io.reset := reset
