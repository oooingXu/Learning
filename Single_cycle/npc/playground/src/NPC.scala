...
class NPC extends Module {
    ...
    val CsrWr  = Output(UInt(32.W))
    val Recsr  = Output(UInt(32.W))
  ...
  io.AluMuxa      := idu.io.AluMuxa
  io.AluMuxb      := idu.io.AluMuxb
  io.AluSel       := idu.io.AluSel
  io.AluSela      := idu.io.AluSela
  io.AluSelb      := idu.io.AluSelb
  ...
  io.CsrWr        := idu.io.CsrWr
  io.Recsr        := idu.io.Recsr
  io.Csr          := idu.io.Csr
  io.csr          := idu.io.csr
  io.mtvec        := idu.io.mtvec
